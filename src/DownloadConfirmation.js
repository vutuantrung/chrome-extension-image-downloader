import { Checkbox } from "./Components/Settings/AdvancedFilters/Checkbox.js";
    ...
    return (
        <div style={{ gridColumn: '1 / -1', ...style }} {...props}>
            ...
            <div style={{ display: 'flex', gap: '4px', alignItems: 'center' }}>
                ...
                <input type="button" class="neutral ghost" value="Cancel" onClick={onClose} />

                <input type="button" class="success" value="Yes, Download"
                    onClick={() => {
                        onClose();
                        onConfirm();
                    }} />
