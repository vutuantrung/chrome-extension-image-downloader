...
export const Youtube = (props) => {
    ...
    return (
        <div className="yt-content">
            ...
            {/* Thumbs */}
            <img className="thumbs" src={data.thumbnails[data.thumbnails.length - 1].url} alt="thumbnails" />
            ...
            <div className="details">
                <div className="detail-item">
                    <img src={icons.viewsIcon} alt="" />
                    <div>{data.viewCount}</div>
                </div>
                <div className="detail-item">
                    <img src={icons.uploadIcon} alt="" />
                    <div>{data.uploadDate.split(" ")[0]}</div>
                </div>

                <div className="detail-item">
                    <img src={icons.likeIcon} alt="" />
                    <div>{data.likes}</div>
                </div>

                <div className="detail-item">
                    <img src={icons.dislikeIcon} alt="" />
                    <div>{data.dislikes}</div>
                </div>

                <div className="detail-item">
                    <img src={icons.ratingIcon} alt="" />
                    <div>{data.rating.toFixed(2)}</div>
                </div>
            </div>
            ...
            <div className="formats">
                {sortItems(data.formats).map((f, index) => {
                    const priorityVideo = f.hasVideo && !f.hasAudio && f.height >= 2160;
                    const videoDetails = f.hasVideo ? f.height + "p" : "";
                    const birate = f.bitrate;
                    const mimeType = f.mimeType.replace("video/", "").split(";")[0];
                    const tooltipContent = videoDetails + " " + mimeType + " " + birate;
                    return (
                        <div
                            className="tooltip"
                        ...
                        >
                            ...
                            >
                                <div className="video-format">
                                    <img
                                        src={mimeType === "mp4" ? images.mp4FormatIcon : images.webmFormatIcon}
