...
export const FilterPages = ({ options, setOptions }) => {
	const widthSliderRef = useSlider("width", options, setOptions);
	const heightSliderRef = useSlider("height", options, setOptions);

	const showMediasSorting = options.mode === "normal" || options.mode === "tumblr" || options.mode === "reddit";
			...
			<table className="grid">
				...
				<tbody>
					<tr id="image_width_filter">
						...
						<td>
							<label
								className={options.filter_min_width_enabled === "true" ? "" : "light"}
								style={{
									display: "flex",
						...
						<td>
							<label
								className={options.filter_max_width_enabled === "true" ? "" : "light"}
								style={{
									display: "flex",
					...
					<tr id="image_height_filter">
						...
						<td>
							<label
								className={options.filter_min_height_enabled === "true" ? "" : "light"}
								style={{
									display: "flex",
									justifyContent: "flex-end",
									alignContent: "center",
						...
						<td>
							<label
								className={options.filter_max_height_enabled === "true" ? "" : "light"}
								style={{
									display: "flex",
									justifyContent: "space-between",
									alignItems: "center",
